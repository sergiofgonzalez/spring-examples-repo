...
VALUES
  ('juan', 'Juan', 'Cazares', 'juan.cazares@example.com', 'p@ssword', 1, 1, 1, CURRENT_TIMESTAMP),
  ('elvira', 'Elvira', 'Cazares', 'elvira.cazares@example.com', 'p@ssword', 1, 1, 1, CURRENT_TIMESTAMP);
